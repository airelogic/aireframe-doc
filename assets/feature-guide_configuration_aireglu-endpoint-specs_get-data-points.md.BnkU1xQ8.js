...
<span class="line"><span>		}</span></span>
<span class="line"><span>	}</span></span>
<span class="line"><span>}</span></span></code></pre></div><ul><li><strong>Explanation of properties</strong>: Any object can be passed in to the DataExtract Options property that meets the schema returned by the endpoint <a href="/feature-guide/configuration/aireglu-endpoint-specs/get-dataset-options-schema.html"><code>endpoint-prefix</code>-aireframe-get-dataset-options-schema</a>. You may then use these options to determine what data to return.</li></ul><h3 id="response" tabindex="-1">Response <a class="header-anchor" href="#response" aria-label="Permalink to &quot;Response&quot;">​</a></h3><ul><li><strong>Format</strong>: JSON</li><li><strong>Schema</strong>:</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>{</span></span>
<span class="line"><span>	&quot;$schema&quot;: &quot;http://json-schema.org/draft-04/schema#&quot;,</span></span>
...
<span class="line"><span>		}</span></span>
<span class="line"><span>	]</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,18),o=[e];function l(u,i,q,c,r,d){return n(),s("div",null,o)}const m=t(p,[["render",l]]);export{h as __pageData,m as default};
